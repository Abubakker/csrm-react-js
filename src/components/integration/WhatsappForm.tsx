...
const WhatsappForm: React.FC<WhatsappFormProps> = ({
  ...
  return (
    ...
    >
      <Form.Item
        label={t('whatsapp_business_acc_id_label')}
        name="businessId"
        className="mb-4 font-medium"
        rules={[
          {
            required: true,
            message: `${t('whatsapp_business_acc_id_req_msg')}`,
          },
        ]}
      >
        <Input
          className="rounded-[10px] p-3"
          placeholder={`${t('whatsapp_business_acc_id_placeholder')}`}
        />
      </Form.Item>

      <Form.Item
        label={t('whatsapp_permanent_token_label')}
        name="token"
        className="mb-4 font-medium"
        rules={[
          {
            required: true,
            message: `${t('whatsapp_permanent_token_req_msg')}`,
          },
        ]}
      >
        <Input
          className="rounded-[10px] p-3"
          placeholder={`${t('whatsapp_permanent_token_placeholder')}`}
        />
      </Form.Item>
      ...
      <Form.Item
        ...
        rules={[
          {
            required: true,
            message: `${t('phone_no_id_req_msg')}`,
          },
        ]}
      >
        <Input
          className="rounded-[10px] p-3"
          placeholder={`${t('phone_no_id_placeholder')}`}
        />
      </Form.Item>
